...
- (void)photoBrowser:(MWPhotoBrowser *)photoBrowser backDelegate:(NSUInteger)index;
...
@property (nonatomic) BOOL uploadButton;
@property (nonatomic, readonly) NSUInteger currentIndex;
@property (weak, nonatomic) NSString *desText;
